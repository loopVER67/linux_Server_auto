...
sudo mysql -u root -pAdmin1234 -e "grant all privileges on wordpress.* to 'ici2admin'@'%';"
...
sudo mysql -u root -pAdmin1234 -e "grant all privileges on wordpress.* to 'webmail'@'%';"
sudo mysql -u root -pAdmin1234 -e "flush privileges"
